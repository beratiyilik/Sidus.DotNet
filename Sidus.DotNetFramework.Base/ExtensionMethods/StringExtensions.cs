...
namespace System
{
    ...
    {
        public static string ToTitleCase(this string value) => !string.IsNullOrEmpty(value) ? CultureInfo.CurrentCulture.TextInfo.ToTitleCase(value.ToLower()) : string.Empty;
        ...
        public static bool IsNull(this string val) => val == null;
